...
const heroImage = "/assets/hero-immobilier.jpg";
    ...
    return (
        <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <Image src={heroImage} alt="Immobilier moderne" width={1920} height={600} priority style={{ objectFit: "cover", width: "100%", height: "100%" }} />
                <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-primary/40"></div>
            </div>

            {/* Content */}
            <div className="relative z-10 container text-center text-white">
                <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-in slide-in-from-bottom-4 duration-700">Trouvez votre bien idéal</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input placeholder="Ville, code postal..." className="pl-10 bg-background border-border" />
                            </div>
                        </div>
