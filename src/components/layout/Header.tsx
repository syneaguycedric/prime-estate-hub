...
const Header = ({ onOpenFilters, onSearch, onReset, view, onViewChange, activeFiltersCount = 0, searchQuery: externalSearchQuery }: HeaderProps) => {
    ...
    React.useEffect(() => {
        console.log("[HEADER] User data changed:", {
            ...
            isAdvertiser: user?.role?.code === "ADVERTISER",
        ...
        >
            <div className="container flex h-16 items-center justify-between">
                    ...
                    <div className="relative w-full flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                className="pl-10 pr-12 bg-card border-border focus:bg-card transition-colors"
                                value={searchQuery}
                            ...
                            <Button
                                ...
                                size="sm"
                                className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 p-0 shadow-sm transition-all duration-200 hover:scale-110 hover:-translate-y-1/2 active:scale-95 active:-translate-y-1/2"
                ...
                <nav className="flex items-center space-x-2">
                    ...
                    <Button variant="hero" size="sm" onClick={handlePublishClick} className="text-sm md:text-base lg:text-lg">
