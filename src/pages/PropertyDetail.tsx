...
const PropertyDetail = () => {
    ...
    useEffect(() => {
        ...
        metaDesc.setAttribute(
            "content",
            `${property.title} à ${property.location}. ${property.surface}, ${property.bedrooms ?? 0} chambres, ${property.bathrooms ?? 0} salles de bain.`
        );
                        ...
                        <div className="lg:col-span-2">
                            ...
                            >
                                {property.images.map((image, index) => (
                                    ...
                                    >
                                        <img src={image} alt={`Miniature ${index + 1}`} className="w-20 h-16 object-cover" />
                                    </motion.button>
                                ))}
                            </motion.div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-muted-foreground leading-relaxed">
                                    Découvrez ce bien idéalement situé, offrant un excellent compromis entre confort et praticité. Lumineux, bien agencé et proche des commodités,
                                    il conviendra parfaitement à votre projet. Ce bien bénéficie d'une exposition optimale et d'aménagements de qualité qui sauront vous séduire.
                                </p>
                                ...
                                <div className="lg:hidden">
                                    ...
                                    <p className="text-muted-foreground mb-4">
                                        Situé dans un quartier recherché, ce bien bénéficie d'un environnement calme tout en restant proche des commodités essentielles : commerces,
                                        écoles, transports en commun et espaces verts.
                                    </p>
