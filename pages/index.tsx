        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                "https://facebook.com/kylimmo",
                "https://twitter.com/kylimmo",
                "https://linkedin.com/company/kylimmo"
              ],
              contactPoint: {
                "@type": "ContactPoint",
      ...
      <div className="min-h-screen bg-background">
        <AnimatePresence mode="wait">
          ...
          {currentView === "commune-selection" && (
            ...
            >
              <CommuneSelector 
                onBack={handleBackToZoneSelection}
                onSearch={handleCommuneSearch}
              />
            </motion.div>
          )}
        </AnimatePresence>
...
function generateSeoData(baseUrl: string) {
  return {
    ...
    description: "Recherchez des biens immobiliers à Abidjan et partout en Côte d'Ivoire. Plus de 3,700 annonces disponibles : appartements, maisons, villas, terrains et biens commerciaux.",
